...
async def _get_report_data(session_id: int, db: AsyncSession) -> dict:
    ...
    return {
        ...
        "summary": {
            ...
            "min_congruence": summary.min_congruence if summary else None,
            "max_congruence": summary.max_congruence if summary else None,
            ...
            "high_relevance_micro_expressions": summary.high_relevance_micro_expressions if summary else 0,
